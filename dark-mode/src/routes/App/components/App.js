...
function App() {
  ...
  return (
    <div className={"app " + (style ? "dark-mode" : "")}>
      <div className="level">
        <div>
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={changeStyle}>
          <FontAwesomeIcon color={style ? "#FFA500" : "black"} icon={style ? faSun : faMoon} />
        </button>
